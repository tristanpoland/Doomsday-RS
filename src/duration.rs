    ...
    pub fn parse(input: &str) -> crate::Result<Duration> {
        ...
        for cap in re.captures_iter(input) {
            let num: i64 = cap["num"].parse()
                .map_err(|e| crate::DoomsdayError::invalid_input(format!("Invalid number: {}", e)))?;
            ...
            let duration = match unit {
                ...
                _ => return Err(crate::DoomsdayError::invalid_input(format!("Unknown unit: {}", unit))),
            };
        ...
        if total == Duration::zero() {
            return Err(crate::DoomsdayError::invalid_input("No valid duration found"));
        }
...
mod tests {
    ...
    fn test_parse_duration() {
        ...
        assert_eq!(
            ...
            Duration::days(365) + Duration::days(2) + Duration::hours(3) + Duration::minutes(4) + Duration::seconds(5)
        );
    }
